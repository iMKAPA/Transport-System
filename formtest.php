    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="home">
                    <p style="margin-top: 1rem; font-weight: bold; "><a href="index.html"> Home</a>/ <a href="trains.html"> Vehicle</a> / Booking</p>
                </div>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Ticket</h4>
                            ...
                            <section>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                        <div class="form-group">
                                            <label>BriefLY comment on your expection through the travel</label>
